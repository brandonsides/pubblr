...
var DefaultEntityUnmarshaler pkgJson.InterfaceUnmarshaler

func init() {
	DefaultEntityUnmarshaler.RegisterUnmarshalFn("Question", func(u *pkgJson.InterfaceUnmarshaler, b []byte) (interface{}, error) {
